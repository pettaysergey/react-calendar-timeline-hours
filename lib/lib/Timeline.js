  ...
  _createClass(ReactCalendarTimeline, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      var _props = this.props,
          setCustomUnit = _props.setCustomUnit,
    ...
    value: function infoLabel() {
      ...
      if (this.state.dragTime) {
        label = (0, _moment2.default)(this.state.dragTime).locale('ru').format('LLL') + ', \n        ' + this.state.dragGroupTitle;
      } else if (this.state.resizeTime) {
        label = (0, _moment2.default)(this.state.resizeTime).locale('ru').format('LLL');
      }
...
ReactCalendarTimeline.propTypes = {
  setCustomUnit: _propTypes2.default.func,
