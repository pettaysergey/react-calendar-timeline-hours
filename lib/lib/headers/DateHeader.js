...
var _InrervalWrapper = require('./InrervalWrapper');

var _InrervalWrapper2 = _interopRequireDefault(_InrervalWrapper);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        function (_ref2) {
          ...
          var subarr = [];
          var size = 7;
          for (var i = 0; i < Math.ceil(intervals.length / size); i++) {
            subarr[i] = intervals.slice(i * size, i * size + size);
          }
          return _react2.default.createElement(
            _react2.default.Fragment,
            null,
            unit === 'day' && _react2.default.createElement(
              'div',
              _extends({
                className: _this2.props.className
              }, getRootProps({ style: _this2.getRootStyle() })),
              subarr.map(function (elem, i) {
                return _react2.default.createElement(_InrervalWrapper2.default, {
                  key: i,
                  item: elem,
                  unit: unit,
