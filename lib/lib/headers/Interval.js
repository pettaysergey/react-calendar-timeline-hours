  ...
  _createClass(Interval, [{
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          intervalRenderer = _props2.intervalRenderer,
          headerData = _props2.headerData;

      var Renderer = intervalRenderer;
      var redStyle = ['сб', 'вс'].includes(intervalText);
      if (Renderer) {
      ...
      return _react2.default.createElement(
        ...
        _extends({}, this.getIntervalProps({}), {
          className: 'rct-dateHeader ' + (this.props.primaryHeader ? 'rct-dateHeader-primary' : '') + ' ' + (redStyle ? 'rct-holyday-date' : 'rct-usial-date')
        }),
